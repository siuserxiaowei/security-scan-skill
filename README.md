...
### English
Local security scan skill for npm supply-chain checks, dependency risk, and potential secret exposure.
...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/security-scan-skill
